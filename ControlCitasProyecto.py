...
def mostrar_formulario(event):
    ...
    if seleccion == "Registrarse":
     ...
     tk.Label(formulario_frame, text="Sexo:", bg="gray").pack()
     valor = tk.StringVar()
     en_sexo = tk.OptionMenu(formulario_frame, valor, "Masculino", "Femenino", "Otro")
     en_sexo.pack()
     
     tk.Label(formulario_frame, text="Edad: ",font=("Calibri", 10), bg="gray").pack()
     en_edad=tk.Entry(formulario_frame, font=("Calibri", 10))
     en_edad.pack(pady=8)

     tk.Label(formulario_frame, text="Telefono: ",font=("Calibri", 10), bg="gray").pack()
     en_telefono=tk.Entry(formulario_frame, show="*", font=("Calibri", 10))
     en_telefono.pack(pady=8)

     tk.Label(formulario_frame, text="Cargo: ",font=("Calibri", 10), bg="gray").pack()
